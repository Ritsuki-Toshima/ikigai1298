class AppointmentsController < ApplicationController
  ...
  def create
    ...
    if @appointment.save
      ...
      SendSmsService.new(@appointment.user, "Dear #{@appointment.user.first_name.capitalize}, #{@trusted_user.first_name.capitalize} added a new #{@appointment.name} appointment for you on #{@appointment.start_time.strftime('%A, %b %d')} at #{@appointment.start_time.strftime('%l:%M %p')}. Check out the Ikigai app at: https://ikigai1298-c2bc721aa13b.herokuapp.com").call
    else
